...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(265, 482, 463, 534) action Start()
        hotspot(821, 27, 709, 502) action ShowMenu("load")
        hotspot(914, 551, 782, 509) action ShowMenu("preferences")
        hotspot(1430, 0, 490, 545) action Quit(confirm=True)
